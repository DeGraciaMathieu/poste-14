...
<!--
  ...
  ==========================================================================
     ...
     INUTILE DE CHERCHER ICI : LA SOLUTION N'EST PAS DANS LE CODE SOURCE.

     Le message en clair et la clé des rotors restent sur le serveur.
     Le navigateur ne reçoit que le texte CHIFFRÉ et une empreinte SHA-256.
     Aucune réponse ne traîne ici.

     Tourne les rotors c'est ça, le jeu. ;)
